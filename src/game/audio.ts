/**
 * SkiFree Retro 8-bit Audio Synthesizer
 * Uses the Web Audio API for zero-dependency retro sound effects.
 */
...
class SoundEngine {
  ...
  constructor() {
    ...
    const saved = localStorage.getItem('skifree_muted');
    if (saved !== null) {
  ...
  public toggleMute(): boolean {
    ...
    localStorage.setItem('skifree_muted', String(this.isMuted));
    return this.isMuted;
  }
